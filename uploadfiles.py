...
class UploadFilesToDB:#1)is used to connect to sql db to upload and retrive file search results.
    ...
    def search_in_db_for_file(self, fileName):##"searches for a file in db" by "taking filename as input".
