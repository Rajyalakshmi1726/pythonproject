...
numpy_b=np.array([5,6,7,8.5])
print(numpy_a * numpy_b )
print(numpy_a.dtype)##data type
print(numpy_b.itemsize)
'''

##3D-array
import numpy as np
array_3d=np.array([[[1,2],[3,4]],[[7,2],[9,4]]])
...
print(np.hstack([a_v1, a'''


import numpy as np
data_from_text_file=np.genfromtxt('C:\home\main\sub',delimiter=',')
